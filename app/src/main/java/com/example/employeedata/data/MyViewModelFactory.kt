...
*
* */
class AppViewModelFactory2(val application: Application) : ViewModelProvider.Factory {
...
// val vm: AppViewModelFactory by lazy {
//        ViewModelProviders.of(this, AppViewModelFactory { AppViewModelFactory(context) }).get(EmployeeViewModel::class.java)
//}